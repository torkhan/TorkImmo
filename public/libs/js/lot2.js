function initMap(listener) {
    ...
    let contentMaison= "<h5>Appartement 4 pièces</h5> <p>85 m²</p><p>Loyer 945 €/mois</p>";
    ...
    let markerMaison = new google.maps.Marker({
        position: maison,
        map: map,
        icon: new google.maps.MarkerImage('../src/images/icone-appartement.jpg'),
        content: contentMaison
    });
    ...
    directionsService.route(request, function (response, status) {
        if (status == google.maps.DirectionsStatus.OK) {
            ...
            directionsDisplay.setOptions({polylineOptions: {
                    strokeColor: "brown"}//pour changer la couleur de la route
            });
